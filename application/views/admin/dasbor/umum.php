...
<div class="col-md-6">
    ...
    <textarea name="deskripsi" rows="3" class="form-control" placeholder="Summary of the company"><?php echo $site['deskripsi'] ?></textarea>
    </div>
    ...
    <input type="text" name="tlp" placeholder="021-000000" value="<?php echo $site['tlp'] ?>" class="form-control">
    </div>
