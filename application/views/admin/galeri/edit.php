...
<div class="col-md-4">
	<div class="form-group form-group-lg">
		...
		<select name="posisi_galeri" class="form-control">
		  ...
		  <option value="Slide" <?php if($galeri->posisi_galeri=="Slide") { echo "selected"; } ?> >Homepage Slider</option>
		</select>
	</div>
</div>
...
<div class="col-lg-12">
  ...
  <textarea name="isi_galeri" class="form-control" placeholder="Isi Galeri" id="keterangan"><?php echo $galeri->isi_galeri ?></textarea>
  </div>
