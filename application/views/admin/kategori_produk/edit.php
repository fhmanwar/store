...
// Form
echo form_open(base_url('admin/kategori_produk/edit/'.$kategori_produk->id_kategori));
?>

<div class="form-group">
<label>Nama kategori</label>
<input type="text" name="nama_kategori" placeholder="Nama kategori" value="<?php echo $kategori_produk->nama_kategori ?>" required class="form-control">
</div>
