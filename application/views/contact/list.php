  ...
  <div class="container">
    <div class="col-md-12">
      ...
      <div class="row contact-info-wrap">
        ...
        <div class="col-lg-3">
          <p><span><i class="icon-phone3"></i></span> <a href="tel://<?php echo $tlp ?>"><?php echo $tlp ?></a></p>
        </div>
        <div class="col-lg-3">
          <p><span><i class="icon-paperplane"></i></span> <a href="mailto:<?php echo $email ?>"><?php echo $email ?></a></p>
        </div>
        <div class="col-lg-3">
